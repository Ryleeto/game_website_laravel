            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                      ...
                      <li><a href="{{ route('shop') }}" class="{{ Route::currentRouteName() == 'shop' ? 'active' : '' }}">Our Shop</a></li>
                      <li><a href="{{ route('details') }}" class="{{ Route::currentRouteName() == 'details' ? 'active' : '' }}">Product Details</a></li>
